...
<div>
	...
	<input type="hidden" id="m_id" name="m_id" value="${reply.m_id}">
		<table class="table">
			...
			<tr>
				<td>제목</td>
				<td><input type="text" class="form-control" name="i_title" id="i_title" value="↳[답글] ${reply.i_title}"></td>
			</tr>
			<tr>
				<td>문의 항목</td>
				<td>
			...
			<tr>
				<td>내용</td>
				<td><textarea class="form-control" name="i_content" id="i_content">re: ${reply.i_content}</textarea></td>
			</tr>
		</table>
	</form>
	<br>
