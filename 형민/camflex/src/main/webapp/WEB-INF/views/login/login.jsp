		...
		<form id="loginCheck" name="loginCheck" action="/loginCheck"
			...
			<div>
				<input type="submit" value="로그인" /> <input type="button"
					value="아이디 찾기" onClick="location.href='findIdForm.do'" /> <input
					type="button" value="비밀번호 찾기"
					onClick="location.href='findPwForm.do'" /> <input type="button"
					value="회원가입" onClick="location.href='joinForm.do'" />
			</div>
		</form>
	</c:if>
