				...
				<c:forEach items="${productList}" var="product">
					<div class="well" style="height: 190px">
						...
						<div class="col-sm-8">
							...
							<table>
								<tr>
									<td><font size="10"><a href="/">${product.p_name}</a></font></td>
								</tr>
								<tr>
									<c:if test="${product.p_type  eq '오토'}">
									<td><a href="/">안녕하세요. 캠플렉스 오토 캠핑장 입니다.<br> 자세한 내용은 상세 페이지에서 구경하세요.</a></td>
									</c:if>
									<c:if test="${product.p_type eq '글램핑'}">
									<td><a href="/">안녕하세요. 캠플렉스 글램핑 캠핑장 입니다.<br> 자세한 내용은 상세 페이지에서 구경하세요.</a></td>
									</c:if>
									<c:if test="${product.p_type eq '차박'}">
									<td><a href="/">안녕하세요. 캠플렉스 차박 캠핑장 입니다.<br> 자세한 내용은 상세 페이지에서 구경하세요.</a></td>
									</c:if>
								</tr>						
							</table>
							</div>
