...
public class AdminProductController {
	...
	public String productDetail(@ModelAttribute ProductVO pvo, Model model, HttpServletRequest request, HttpServletResponse response)throws Exception {
		sessionCheck(request, response, "로그인 후 가능합니다.");
	...
	public String updateForm(@ModelAttribute ProductVO pvo, Model model, HttpServletRequest request, HttpServletResponse response)throws Exception {
		sessionCheck(request, response, "로그인 후 가능합니다.");
