...
public class ProductVO {
	...
	public ProductVO(int p_number, String p_type, String p_name, int p_price, String p_information, String p_mainphoto, String p_photo1, String p_photo2, String p_photo3) {
